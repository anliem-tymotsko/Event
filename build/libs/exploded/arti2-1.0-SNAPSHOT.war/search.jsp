            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href=${pageContext.request.contextPath}/search?name_find=${event.id}>Find</a>
                    </div>
                </div>
            </div>
        </div>
...
<form action="${pageContext.request.contextPath}/search?name_find=${name_find}" method="post" class="mx-auto" style="width: 600px; ">
